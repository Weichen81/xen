...
const struct cmd_spec cmd_table[] = {
    ...
    { "virtio-net-attach",
      &main_virtio_netattach, 1, 1,
      "Create a new virtio net device",
      " TBD\n"
    },
    { "virtio-net-list",
      &main_virtio_netlist, 0, 0,
      "List virtio net devices for a domain",
      "<Domain(s)>",
    },
    { "virtio-net-detach",
      &main_virtio_netdetach, 0, 1,
      "Destroy a domain's virtio net device",
      "<Domain> <DevId>",
    },
    { "virtio-console-attach",
      &main_virtio_consoleattach, 1, 1,
      "Create a new virtio console device",
      " TBD\n"
    },
    { "virtio-console-list",
      &main_virtio_netlist, 0, 0,
      "List virtio console devices for a domain",
      "<Domain(s)>",
    },
    { "virtio-console-detach",
      &main_virtio_consoledetach, 0, 1,
      "Destroy a domain's virtio console device",
      "<Domain> <DevId>",
    },
    { "uptime",
      &main_uptime, 0, 0,
