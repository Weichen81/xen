...
int main_virtio_netattach(int argc, char **argv);
int main_virtio_netlist(int argc, char **argv);
int main_virtio_netdetach(int argc, char **argv);
int main_virtio_consoleattach(int argc, char **argv);
int main_virtio_consolelist(int argc, char **argv);
int main_virtio_consoledetach(int argc, char **argv);
